...
//                    $time = $this->setAvailabilityTimeStatus($time, $status, $bookingCancellation);
////                } else {
...
//     * @return array
//     */
//    private function setAvailabilityTimeStatus($availabilityTime, $status, $bookingCancellation)
//    {
