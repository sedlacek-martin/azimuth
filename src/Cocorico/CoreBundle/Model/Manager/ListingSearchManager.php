...
//               ->andWhere('l.validTo >= :to')
//               ->andWhere('l.validFrom <= :from')
...
//    }
     ...
     * @return Paginator
     */
    public function getHighestRanked(ListingSearchRequest $listingSearchRequest, $limit, $locale, bool $publicOnly)
    {
        $queryBuilder = $this->getRepository()->getFindByHighestRankingQueryBuilder($limit, $locale, $publicOnly);
