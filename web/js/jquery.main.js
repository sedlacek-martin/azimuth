    ...
    $.extend(ComboBox.prototype, {
        ...
        refreshSelectedText: function () {
            ...
            if (!selectedOption) {
                ...
                // remove indent characters
                let selectedOptionText = selectedOption.innerHTML.trim().split('&amp;#160;').join('');
                this.selectText.attr('class', selectedOptionClasses).html(selectedOptionText);
...
(function ($, window) {
    ...
    jcf.addModule({
        ...
        initStructure: function () {
            ...
            // if element is hidden, dont apply it
            if (this.realElement.css('visibility') !== 'hidden') {
