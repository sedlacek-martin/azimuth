 ...
 */
class Version20211127200544 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE message_thread ADD CONSTRAINT FK_607D18C3174800F FOREIGN KEY (createdBy_id) REFERENCES `user` (id) ON DELETE CASCADE');
