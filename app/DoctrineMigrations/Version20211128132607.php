 ...
 */
class Version20211128132607 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE announcement_to_user DROP FOREIGN KEY FK_96DC9A4C913AEA17');
        ...
        $this->addSql('ALTER TABLE announcement_to_user ADD CONSTRAINT FK_96DC9A4C913AEA17 FOREIGN KEY (announcement_id) REFERENCES announcement (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE page_access DROP FOREIGN KEY FK_69BFDD4AA76ED395');
        $this->addSql('ALTER TABLE page_access CHANGE user_id user_id INT DEFAULT NULL, CHANGE slug slug VARCHAR(100) DEFAULT NULL');
        $this->addSql('ALTER TABLE page_access ADD CONSTRAINT FK_69BFDD4AA76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE announcement_to_user DROP FOREIGN KEY FK_96DC9A4C913AEA17');
        $this->addSql('ALTER TABLE announcement_to_user CHANGE announcement_id announcement_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE dismissedAt dismissedAt DATETIME DEFAULT \'NULL\', CHANGE displayedAt displayedAt DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE announcement_to_user ADD CONSTRAINT FK_96DC9A4C913AEA17 FOREIGN KEY (announcement_id) REFERENCES announcement (id)');
        $this->addSql('ALTER TABLE contact CHANGE user_id user_id INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL, CHANGE recipient_roles recipient_roles LONGTEXT DEFAULT \'NULL\' COLLATE utf8_unicode_ci COMMENT \'(DC2Type:simple_array)\', CHANGE createdAt createdAt DATETIME DEFAULT \'NULL\', CHANGE updatedAt updatedAt DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE contact_category CHANGE subject subject VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8_unicode_ci, CHANGE recipient_roles recipient_roles LONGTEXT DEFAULT \'NULL\' COLLATE utf8_unicode_ci COMMENT \'(DC2Type:simple_array)\'');
        ...
        $this->addSql('ALTER TABLE page_access ADD CONSTRAINT FK_69BFDD4AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
