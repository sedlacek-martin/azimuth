 ...
 */
class Version20211107095306 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE contact CHANGE user_id user_id INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL, CHANGE createdAt createdAt DATETIME DEFAULT NULL, CHANGE updatedAt updatedAt DATETIME DEFAULT NULL, CHANGE reply reply LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE announcement_to_user CHANGE announcement_id announcement_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE dismissedAt dismissedAt DATETIME DEFAULT \'NULL\', CHANGE displayedAt displayedAt DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE contact CHANGE user_id user_id INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL, CHANGE reply reply LONGTEXT NOT NULL COLLATE utf8_unicode_ci, CHANGE createdAt createdAt DATETIME DEFAULT \'NULL\', CHANGE updatedAt updatedAt DATETIME DEFAULT \'NULL\'');
