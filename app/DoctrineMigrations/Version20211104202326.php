 ...
 */
class Version20211104202326 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE announcement_to_user DROP FOREIGN KEY FK_96DC9A4CA76ED395');
        ...
        $this->addSql('ALTER TABLE announcement_to_user ADD CONSTRAINT FK_96DC9A4CA76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE announcement_to_user DROP FOREIGN KEY FK_96DC9A4CA76ED395');
        $this->addSql('ALTER TABLE announcement_to_user CHANGE announcement_id announcement_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE dismissedAt dismissedAt DATETIME DEFAULT \'NULL\', CHANGE displayedAt displayedAt DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE announcement_to_user ADD CONSTRAINT FK_96DC9A4CA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
