 ...
 */
class Version20211105200224 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE contact ADD user_id INT DEFAULT NULL, ADD category_id INT DEFAULT NULL, ADD reply LONGTEXT NOT NULL, ADD recipient_roles LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', DROP phone, CHANGE createdAt createdAt DATETIME DEFAULT NULL, CHANGE updatedAt updatedAt DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE contact ADD CONSTRAINT FK_4C62E63812469DE2 FOREIGN KEY (category_id) REFERENCES contact_category (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE contact_category ADD allow_subject TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE contact ADD phone VARCHAR(20) DEFAULT \'NULL\' COLLATE utf8_unicode_ci, DROP user_id, DROP category_id, DROP reply, DROP recipient_roles, CHANGE createdAt createdAt DATETIME DEFAULT \'NULL\', CHANGE updatedAt updatedAt DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE contact_category DROP allow_subject');
